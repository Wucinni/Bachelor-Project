...
def dataset_grabber(data_source):
    if exists('ToBeWrittenNameOfCSV.csv'):
        train_data = pd.read_csv(r'C:\Users\Dennis\PycharmProjects\Bachelor-Project\1600000tweets.csv', encoding="ISO-8859-1", header=None)
        ...
        train_data.to_csv('1600000tweetsNOTCLEANED.csv', index=False)
        train_data.columns = ['sentiment', 'text']
